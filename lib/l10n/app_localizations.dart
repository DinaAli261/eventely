...
abstract class AppLocalizations {
  ...
  /// No description provided for @firstScreenBody.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @firstOnboardingBody.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @secondOnboardingBody.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @thirdOnboardingBody.
  ///
  /// In en, this message translates to:
